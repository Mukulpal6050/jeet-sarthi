...
const ContactForm = () => {
    return (
        <section
            className="relative w-full bg-cover bg-center bg-no-repeat py-20 px-6 sm:px-10 md:px-20 lg:px-28"
            style={{
                backgroundImage:
        ...
        >
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-white">
                ...
                {/* Form */}
                <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 bg-transparent p-6 md:p-10 rounded-lg">
                    {/* Name */}
                    <div className="flex flex-col">
                        ...
                        <input
                            type="text"
                            placeholder="Name"
                            className="w-full rounded-sm px-4 py-3 text-[#333] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#005EB8]"
                        />
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative">
                            ...
                            />
                            {/* ✅ Moved to left side */}
                            <span className="absolute left-3 bottom-[-32px] text-[#D91A60] text-sm font-medium cursor-pointer">
                                Send OTP
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col relative">
                        ...
                        <select className="appearance-none w-full rounded-sm px-4 py-3 pr-10 text-[#333] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#005EB8]">
                    ...
                    <div className="md:col-span-2 flex flex-col">
                        <label className="text-sm font-semibold mb-1">How Can We Help?</label>
                        <div className="relative">
                            <select
                                className="appearance-none w-full rounded-sm px-4 py-3 pr-10 text-[#333] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#005EB8]"
